...
@Component({
    selector: "GetUserReason",
    templateUrl: "./GetUserReason.component.html",
    styleUrls: ["./GetUserReason.component.scss"],
...
export class GetUserQuestionFormDialogComponent implements OnInit {
    ...
    constructor(
        public dialogRef: MatDialogRef<GetUserQuestionFormDialogComponent>,
