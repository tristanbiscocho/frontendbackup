...
@Component({
  selector: 'elc-gas-details',
  templateUrl: './elc-gas-details.component.html',
  styleUrls: ['./elc-gas-details.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ElcGasModalComponent implements OnInit {
 Data: any;
 dialogRef1: any;
...
//  IBANMask = '[a-zA-Z]{2}\-[0-9]{2}\-[a-zA-Z0-9]{4}\-[0-9]{7}\-([a-zA-Z0-9]?){0,16}'
 ...
 energy: any;
  constructor(public dialogRef: MatDialogRef<ElcGasModalComponent>,
    @Inject(MAT_DIALOG_DATA) private data: any,
    public dialog: MatDialog,   private _formBuilder: FormBuilder
    ) 
    {
        this.Data = data;
        this.energy = this.Data;
    }
