...
@Component({
    selector: 'not-interested-customers',
    templateUrl: './not-interested-customers.component.html',
    styleUrls: ['./not-interested-customers.component.scss'],
    providers: [
        {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
        {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
    ]
})
export class NotInterestedCustomers implements OnInit {
    tableOffset = 0;
    customers:any=[];
    ...
    getCustomerdata()
    {
        ...
        this._partnerService.getNotInterestedCustomer(data,this.currentUser.Id).subscribe(
            response => {
