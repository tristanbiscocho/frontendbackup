...
@Component({
    selector: "app-knowledge-base-dashboard",
    templateUrl: "./knowledge-base-dashboard.component.html",
    styleUrls: ["./knowledge-base-dashboard.component.scss"],
})
export class KnowledgeBaseDashboardComponent implements OnInit {
    constructor(
