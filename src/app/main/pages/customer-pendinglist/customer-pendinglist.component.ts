...
@Component({
    selector: "customer-pendinglist",
    templateUrl: "./customer-pendinglist.component.html",
    styleUrls: ["./customer-pendinglist.component.scss"],
    providers: [
        {
            provide: DateAdapter,
...
export class CustomerPendingListComponent implements OnInit {
    dialogRef: any;
    event: any = 0;
    searchCustomer: any;
    customer: any[];
    ...
    verifyUser(row): any {
        ...
        this.confirmDialogRef.componentInstance.confirmMessage =
            "Are you sure want to approve user?";
    ...
    rejectUser(row): any {
        ...
        this.confirmDialogRef.componentInstance.confirmMessage =
            "Are you sure want to reject user?";
