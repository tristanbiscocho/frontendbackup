...
export class AccountDashboardComponent implements OnInit {
    ...
    public lineChartData: ChartDataSets[] = [
        { data: [15, 5, 18, 28, 2, 5, 30], label: "Income" },
        { data: [41, 20, 11, 55, 45, 8, 78], label: "Expense" },
    ];
        ...
        const customFunctionNavItem = {
            ...
            children: [
                ...
                },
                {
                    ...
                    type: "item",
                    icon: "person",
                    url: "/accounts/sale-agent",
                },
                {
                    id: "Supervisors",
                    title: "Supervisors",
                    translate: "Supervisors",
                    type: "item",
                    icon: "person",
                    url: "/accounts/sale-agent",
                },
